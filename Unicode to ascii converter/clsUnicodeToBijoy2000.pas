...
Begin
		 ...
		 Repeat
					...
					If I <= 0 Then
							 break;
					If ((MidStr(fConvertedText, I + 2, 1) = b_t) Or (MidStr(fConvertedText, I + 2, 1) = b_Th) Or (MidStr(fConvertedText, I + 2, 1) = b_L) Or (MidStr(fConvertedText, I + 2, 1) = b_b) Or (MidStr(fConvertedText, I + 2, 1) = A_T_R_2H) Or
...
Begin
		 Result := False;
		 If (wC = b_kh) Or (wC = b_g) Or (wC = b_gh) Or (wC = b_Nn) Or (wC = b_Th) Or (wC = b_d) Or (wC = b_dh) Or (wC = b_n) Or (wC = b_p) Or (wC = b_b) Or (wC = b_m) Or (wC = b_z) Or (wC = b_r) Or (wC = b_L) Or (wC = b_sh) Or (wC = b_ss) Or (wC = b_s)
			 Or (wC = b_h) Or (wC = b_y) Then
					Result := True;
					...
					If I - 1 >= 1 Then Begin
							 If BaseLineRightCharacter(fConvertedText[I - 1]) = True Then Begin
										...
										If fConvertedText[I - 1] = b_r Then Begin
												 If ((MidStr(fConvertedText, I - 3, 3) = b_sh + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_d + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_g + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3,
																				3) = b_t + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_j + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_Th + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3,
																				3) = b_dh + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 5, 5) = b_n + b_Hasanta + b_d + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_p + b_Hasanta + b_r) Or (MidStr(fConvertedText,
																				I - 3, 3) = b_b + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_Bh + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3, 3) = b_m + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 3,
																				3) = b_s + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 5, 5) = b_m + b_Hasanta + b_p + b_Hasanta + b_r) Or (MidStr(fConvertedText, I - 5, 5) = b_ss + b_Hasanta + b_p + b_Hasanta + b_r) Or
										...
										Else If fConvertedText[I - 1] = b_L Then Begin
												 If ((MidStr(fConvertedText, I - 3, 3) = b_g + b_Hasanta + b_L) Or (MidStr(fConvertedText, I - 3, 3) = b_p + b_Hasanta + b_L) Or (MidStr(fConvertedText, I - 3, 3) = b_b + b_Hasanta + b_L) Or (MidStr(fConvertedText, I - 3,
																				3) = b_sh + b_Hasanta + b_L) Or (MidStr(fConvertedText, I - 3, 3) = b_s + b_Hasanta + b_L) Or (MidStr(fConvertedText, I - 5, 5) = b_s + b_Hasanta + b_p + b_Hasanta + b_L)) Then
															fConvertedText[I] := A_UKar4
												 Else
															fConvertedText[I] := A_UKar2;
										End
