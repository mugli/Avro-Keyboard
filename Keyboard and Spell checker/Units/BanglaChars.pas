...
Begin
  ...
  If (WC = b_A) Or (WC = b_AA) Or (WC = b_AAkar) Or (WC = b_I) Or (WC = b_II) Or
    (WC = b_IIkar) Or (WC = b_Ikar) Or (WC = b_U) Or (WC = b_Ukar) Or
    (WC = b_UU) Or (WC = b_UUkar) Or (WC = b_RRI) Or (WC = b_RRIkar) Or
    (WC = b_E) Or (WC = b_Ekar) Or (WC = b_OI) Or (WC = b_OIkar) Or (WC = b_O)
    Or (WC = b_Okar) Or (WC = b_OU) Or (WC = b_OUkar) Or (WC = b_Vocalic_L) Or
    (WC = b_Vocalic_LL) Or (WC = b_Vocalic_RR) Or (WC = b_Vocalic_RR_Kar) Or
...
Begin
  ...
  If (WC = b_B) Or (WC = b_Bh) Or (WC = b_C) Or (WC = b_CH) Or (WC = b_D) Or
    (WC = b_Dd) Or (WC = b_Ddh) Or (WC = b_Dh) Or (WC = b_G) Or (WC = b_GH) Or
    (WC = b_H) Or (WC = b_J) Or (WC = b_JH) Or (WC = b_K) Or (WC = b_KH) Or
    (WC = b_L) Or (WC = b_M) Or (WC = b_N) Or (WC = b_NGA) Or (WC = b_Nn) Or
    (WC = b_NYA) Or (WC = b_P) Or (WC = b_Ph) Or (WC = b_R) Or (WC = b_Rr) Or
    (WC = b_Rrh) Or (WC = b_S) Or (WC = b_Sh) Or (WC = b_Ss) Or (WC = b_T) Or
    (WC = b_Th) Or (WC = b_Tt) Or (WC = b_Tth) Or (WC = b_Z) Or (WC = b_Y) Or
...
Begin
  ...
  If (WC = b_AAkar) Or (WC = b_IIkar) Or (WC = b_Ikar) Or (WC = b_Ukar) Or
    (WC = b_UUkar) Or (WC = b_RRIkar) Or (WC = b_Ekar) Or (WC = b_OIkar) Or
    (WC = b_OUkar) Or (WC = b_Vocalic_RR_Kar) Or (WC = b_Vocalic_L_Kar) Or
