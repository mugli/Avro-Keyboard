...
// const unsigned char *);
function pcre_compile(pattern: PAnsiChar; options: LongWord; out errptr: PAnsiChar; out erroffset: Integer; tableptr: TPcre_tableH = nil): TPcreH; cdecl;

// extern pcre *pcre_compile2(const char *, int, int *, const char **,
// int *, const unsigned char *);
function pcre_compile2(pattern: PAnsiChar; options: LongWord; out errorcodeptr: Integer; out errptr: PAnsiChar; out erroffset: Integer; tableptr: TPcre_tableH = nil): TPcreH; cdecl;

// extern pcre_extra *pcre_study(const pcre *, int, const char **);
function pcre_study(pcre: TPcreH; options: LongWord; // must be set to 0
  out errptr: PAnsiChar): TPcre_extraH; cdecl;

// extern int  pcre_info(const pcre *, int *, int *);
function pcre_info(pcre: TPcreH; optptr: PLongWord = nil; firstcharptr: PPAnsiChar = nil): Integer; cdecl;

// extern int  pcre_fullinfo(const pcre *, const pcre_extra *, int, void *);
function pcre_fullinfo(pattern: TPcreH; PCRE_EXTRA: TPcre_extraH; what: Integer; out where): Integer; cdecl;
...
function pcre_exec(pcre: TPcreH; PCRE_EXTRA: TPcre_extraH; subject: PAnsiChar; length: Integer; startoffset: Integer; options: LongWord; ovector: PIntArray; ovecsize: Cardinal): Integer; cdecl;
...
//
function pcre_dfa_exec(pcre: TPcreH; PCRE_EXTRA: TPcre_extraH; subject: PAnsiChar; length: Integer; startoffset: Integer; options: LongWord; ovector: PIntArray; ovecsize: Cardinal;
  workspace: PIntArray; wscount: Cardinal): Integer; cdecl;

// extern int  pcre_copy_substring(const char *, int *, int, int, char *, int);
function pcre_copy_substring(subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringnumber: Integer; buffer: PAnsiChar; bufsize: Integer): Integer; cdecl;

// extern int  pcre_get_substring(const char *, int *, int, int, const char **);
function pcre_get_substring(subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringnumber: Integer; out stringptr: PAnsiChar): Integer; cdecl;

// extern int  pcre_get_substring_list(const char *, int *, int, const char ***);
function pcre_get_substring_list(subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; out listptr: PPAnsiChar): Integer; cdecl;
...
function pcre_config(what: Integer; out where): Integer; cdecl;

// extern int pcre_copy_named_substring(const pcre *code, const char *subject,
// int *ovector, int stringcount, const char *stringname,
// char *buffer, int buffersize);
function pcre_copy_named_substring(code: TPcreH; subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringname: PAnsiChar; buffer: PAnsiChar; buffersize: Integer): Integer; cdecl;

// extern int pcre_get_named_substring(const pcre *code, const char *subject,
// int *ovector, int stringcount, const char *stringname,
// const char **stringptr);
function pcre_get_named_substring(code: TPcreH; subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringname: PAnsiChar; stringptr: PPAnsiChar): Integer; cdecl;

// extern int pcre_get_stringnumber(const pcre *code, const char *name);
function pcre_get_stringnumber(code: TPcreH; name: PAnsiChar): Integer; cdecl;

// extern int  pcre_get_stringtable_entries(const pcre *, const char *,
// char **, char **);
function pcre_get_stringtable_entries(code: TPcreH; name: PAnsiChar; first: PPAnsiChar; last: PPAnsiChar): Integer; cdecl;
...
function regexec(var preg: regex_t; str: PAnsiChar; nmatch: Cardinal; pmatch: regmatch_ptr; eflags: Cardinal): Integer; cdecl;

// size_t
// regerror(int errcode, const regex_t *preg, char *errbuf, size_t errbuf_size)
function regerror(errcode: Integer; var preg: regex_t; errbuf: PAnsiChar; errbuf_size: Cardinal): Integer; cdecl;
...
function pcre_compile(pattern: PAnsiChar; options: LongWord; out errptr: PAnsiChar; out erroffset: Integer; tableptr: TPcre_tableH = nil): TPcreH; cdecl; external;
// PCRE_DLL_NAME name 'pcre_compile';
function pcre_compile2(pattern: PAnsiChar; options: LongWord; out errorcodeptr: Integer; out errptr: PAnsiChar; out erroffset: Integer; tableptr: TPcre_tableH = nil): TPcreH; cdecl; external;
// PCRE_DLL_NAME name 'pcre_compile2';
function pcre_exec(pcre: TPcreH; PCRE_EXTRA: TPcre_extraH; subject: PAnsiChar; length: Integer; startoffset: Integer; options: LongWord; ovector: PIntArray; ovecsize: Cardinal): Integer; cdecl;
external; // PCRE_DLL_NAME name 'pcre_exec';
function pcre_dfa_exec(pcre: TPcreH; PCRE_EXTRA: TPcre_extraH; subject: PAnsiChar; length: Integer; startoffset: Integer; options: LongWord; ovector: PIntArray; ovecsize: Cardinal;
  workspace: PIntArray; wscount: Cardinal): Integer; cdecl; external; // PCRE_DLL_NAME name 'pcre_dfa_exec';
function pcre_study(pcre: TPcreH; options: LongWord; // must be set to 0
  out errptr: PAnsiChar): TPcre_extraH; cdecl; external; // PCRE_DLL_NAME name 'pcre_study';
function pcre_info(pcre: TPcreH; optptr: PLongWord = nil; firstcharptr: PPAnsiChar = nil): Integer; cdecl; external; // PCRE_DLL_NAME name 'pcre_info';
function pcre_fullinfo(pattern: TPcreH; PCRE_EXTRA: TPcre_extraH; what: Integer; out where): Integer; cdecl; external; // PCRE_DLL_NAME name 'pcre_fullinfo';
...
function pcre_get_substring(subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringnumber: Integer; out stringptr: PAnsiChar): Integer; cdecl; external;
// PCRE_DLL_NAME name 'pcre_get_substring';
function pcre_get_substring_list(subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; out listptr: PPAnsiChar): Integer; cdecl; external; // PCRE_DLL_NAME name 'pcre_get_substring_list';
function pcre_copy_substring(subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringnumber: Integer; buffer: PAnsiChar; bufsize: Integer): Integer; cdecl; external;
// PCRE_DLL_NAME name 'pcre_copy_substring';
...
function regexec(var preg: regex_t; str: PAnsiChar; nmatch: Cardinal; pmatch: regmatch_ptr; eflags: Cardinal): Integer; cdecl; external; // PCRE_DLL_NAME name 'regexec';
function regerror(errcode: Integer; var preg: regex_t; errbuf: PAnsiChar; errbuf_size: Cardinal): Integer; cdecl; external; // PCRE_DLL_NAME name 'regerror';
...
function pcre_config(what: Integer; out where): Integer; cdecl; external; // PCRE_DLL_NAME name 'pcre_config';
function pcre_copy_named_substring(code: TPcreH; subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringname: PAnsiChar; buffer: PAnsiChar; buffersize: Integer): Integer; cdecl;
external; // PCRE_DLL_NAME name 'pcre_copy_named_substring';
function pcre_get_named_substring(code: TPcreH; subject: PAnsiChar; ovector: PIntArray; stringcount: Integer; stringname: PAnsiChar; stringptr: PPAnsiChar): Integer; cdecl; external;
// PCRE_DLL_NAME name 'pcre_get_named_substring';
function pcre_get_stringnumber(code: TPcreH; name: PAnsiChar): Integer; cdecl; external; // PCRE_DLL_NAME name 'pcre_get_stringnumber';
function pcre_get_stringtable_entries(code: TPcreH; name: PAnsiChar; first: PPAnsiChar; last: PPAnsiChar): Integer; cdecl; external;
...
begin
  result := CharInSet(AnsiChar(c) , ['0' .. '9', 'A' .. 'F', 'a' .. 'f']);
end;
