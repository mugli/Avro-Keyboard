...
Type
  ...
  Type
    EStringArray = Class(EArray);
      AStringArray = Class(AArray)Protected Procedure SetItem(Const Idx: Integer; Const Value: AnsiString);
      Virtual;
      Abstract;
    ...
    Public
      ...
      Function AddItem(Const Value: AnsiString): Integer; Reintroduce; Overload; Virtual;
      Function AddArray(Const V: StringArray): Integer; Reintroduce; Overload; Virtual;
      Function PosNext(Const Find: AnsiString; Const PrevPos: Integer = -1; Const IsSortedAscending: Boolean = False): Integer;
    End;
  ...
  Type
    ...
    Public
      ...
      Procedure Assign(Const V: Array Of AnsiString); Reintroduce; Overload;
  ...
  Type
    ...
    Protected
      ...
      Function LocateItemHashBuf(Const ValueStrPtr: PAnsiChar; Const ValueStrLen: Integer; Var LookupList, LookupIdx: Integer): Boolean;
      Function LocateItemHash(Const Value: AnsiString; Var LookupList, LookupIdx: Integer): Boolean;
      Procedure Rehash;
    ...
    Public
      ...
      Procedure Delete(Const Idx: Integer; Const Count: Integer = 1); Override;
      Procedure Insert(Const Idx: Integer; Const Count: Integer = 1); Override;
      Function AddItem(Const Value: AnsiString): Integer; Override;

      Function PosNextBuf(Const FindStrPtr: PAnsiChar; Const FindStrLen: Integer; Const PrevPos: Integer = -1): Integer;
...
Function AStringArray.AddItem(Const Value: AnsiString): Integer;
Begin
  Result := Count;
  Count := Result + 1;
  Item[Result] := Value;
...
Procedure AStringArray.Fill(Const Idx, Count: Integer; Const Value: AnsiString);
Var
  I: Integer;
Begin
...
Function AStringArray.PosNext(Const Find: AnsiString; Const PrevPos: Integer; Const IsSortedAscending: Boolean): Integer;
Var
  I, L, H: Integer;
  D: AnsiString;
Begin
...
Function AStringArray.GetAsString: AnsiString;
Var
  I, L: Integer;
Begin
  L := Count;
...
Procedure AStringArray.SetAsString(Const S: AnsiString);
Var
  F, G, L, C: Integer;
Begin
  L := Length(S);
...
Procedure TStringArray.SetItem(Const Idx: Integer; Const Value: AnsiString);
Begin
  {$IFOPT R+}
...
Function TStringArray.GetItem(Const Idx: Integer): AnsiString;
Begin
  {$IFOPT R+}
  If (Idx < 0) Or (Idx >= FCount) Then
    IndexError(Idx);
...
Procedure TStringArray.Assign(Const V: Array Of AnsiString);
Begin
...
Function THashedStringArray.LocateItemHashBuf(Const ValueStrPtr: PAnsiChar; Const ValueStrLen: Integer; Var LookupList, LookupIdx: Integer): Boolean;
Var
  I: Integer;
Begin
  // Hash value
...
Function THashedStringArray.LocateItemHash(Const Value: AnsiString; Var LookupList, LookupIdx: Integer): Boolean;
Begin
  Result := LocateItemHashBuf(Pointer(Value), Length(Value), LookupList, LookupIdx);
End;
...
Begin
  // Swap lookup
  If LocateItemHash(FData[Idx1], L1, I1) And LocateItemHash(FData[Idx2], L2, I2) Then
...
Procedure THashedStringArray.SetItem(Const Idx: Integer; Const Value: AnsiString);
Var
  S: AnsiString;
  I, J: Integer;
Begin
...
Function THashedStringArray.AddItem(Const Value: AnsiString): Integer;
Var
  L: Integer;
Begin
  // add to array
...
Function THashedStringArray.PosNextBuf(Const FindStrPtr: PAnsiChar; Const FindStrLen: Integer; Const PrevPos: Integer): Integer;
Var
  I, J, F, L, P: Integer;
Begin
  // locate first
...
Function THashedStringArray.PosNext(Const Find: AnsiString; Const PrevPos: Integer): Integer;
Begin
