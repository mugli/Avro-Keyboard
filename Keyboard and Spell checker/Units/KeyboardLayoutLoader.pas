...
Begin
		 ...
		 Try
					Try
							 ...
							 If MyCopyFile(LayoutPath, GetAvroDataDir + 'Keyboard Layouts\' + FileName, Overwrite) Then Begin
										...
										Application.MessageBox
											(pchar('Keyboard layout "' + FileName + '" has been installed successfully!' + #10 + '' + #10 + 'Layout name: ' + InternalName + #10 + 'Version: ' + Version + #10 +
																'Developer: ' + Developer + #10 + 'Comment: ' + Comment + #10), 'Avro Keyboard', MB_OK + MB_ICONASTERISK + MB_DEFBUTTON1 + MB_SYSTEMMODAL);
							 ...
							 Else Begin
										Result := False;
										Application.MessageBox(pchar('Keyboard layout "' + FileName + '" was not installed!'), 'Avro Keyboard', MB_OK + MB_ICONHAND + MB_DEFBUTTON1 + MB_SYSTEMMODAL);
							 End;
					...
					Except
							 On E: Exception Do Begin
										...
										Application.MessageBox(pchar('Error installing keyboard layout!' + #10 + '' + #10 + '' + #10 + 'Make sure this is a valid keyboard layout file' + #10 + 'or,' + #10 +
																'You have enough permission to write in keyboard layouts folder' + #10 + 'or,' + #10 + 'Keyboard layouts directory is writable'), 'Avro Keyboard',
