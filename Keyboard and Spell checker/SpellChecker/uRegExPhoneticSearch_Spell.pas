...
Begin
		...
		theRegex := TRegex.Create(AnsiSearchStr);
		 ...
		 { ***************************************** }
		 { Search W_A }
		 If (mSearchIn = 'o') Or (mSearchIn = 'a') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_AA }
		 If (mSearchIn = 'a') Or (mSearchIn = 'i') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_I }
		 If (mSearchIn = 'y') Or (mSearchIn = 'e') Or (mSearchIn = 'i') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_II }
		 If (mSearchIn = 'i') Or (mSearchIn = 'e') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_U }
		 If (mSearchIn = 'o') Or (mSearchIn = 'u') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_E }
		 If (mSearchIn = 'x') Or (mSearchIn = 'o') Or (mSearchIn = 'a') Or (mSearchIn = 'i') Or (mSearchIn = 'e') Or (mSearchIn = 'u') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_OI }
		 If (mSearchIn = 'o') Or (mSearchIn = 'a') Or (mSearchIn = 'i') Or (mSearchIn = 'e') Or (mSearchIn = 'u') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_O }
		 If (mSearchIn = 'w') Or (mSearchIn = 'o') Or (mSearchIn = 'a') Or (mSearchIn = 'i') Or (mSearchIn = 'e') Or (mSearchIn = 'u') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_B }
		 If (mSearchIn = 'b') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_BH }
		 If (mSearchIn = 'b') Or (mSearchIn = 'v') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_C }
		 If (mSearchIn = 'c') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_D }
		 If (mSearchIn = 'd') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_G }
		 If (mSearchIn = 'g') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_H }
		 If (mSearchIn = 'z') Or (mSearchIn = 'r') Or (mSearchIn = 'm') Or (mSearchIn = 'h') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_J }
		 If (mSearchIn = 'z') Or (mSearchIn = 'j') Or (mSearchIn = 'g') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_Jh }
		 If (mSearchIn = 'j') Or (mSearchIn = 'z') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_K }
		 If (mSearchIn = 'x') Or (mSearchIn = 'q') Or (mSearchIn = 'k') Or (mSearchIn = 'c') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_Kh }
		 If (mSearchIn = 'k') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_L }
		 If (mSearchIn = 'l') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_M }
		 If (mSearchIn = 'm') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_N }
		 If (mSearchIn = 'n') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_NYA }
		 If (mSearchIn = 'n') Or (mSearchIn = 'a') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_P }
		 If (mSearchIn = 'p') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_Ph }
		 If (mSearchIn = 'p') Or (mSearchIn = 'f') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_S }
		 If (mSearchIn = 's') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_T }
		 If (mSearchIn = 't') or (mSearchIn = 'r') Then Begin
		 ...
		 { ***************************************** }
		 { Search W_Y }
		 If (mSearchIn = 'u') Or (mSearchIn = 'o') Or (mSearchIn = 'i') Or (mSearchIn = 'e') Or (mSearchIn = 'a') or (mSearchIn = 'y') or (mSearchIn = 'r') Then Begin
