...
Begin
     ...
     {                Search W_I                 }
     If (mSearchIn = 'y')
     Or (mSearchIn = 'e') Or (mSearchIn = 'i')or (mSearchIn='r') Then Begin
     ...
     {                Search W_E                 }
     If (mSearchIn = 'x')
     Or (mSearchIn = 'o') Or (mSearchIn = 'a') Or (mSearchIn = 'i')
     Or (mSearchIn = 'e') Or (mSearchIn = 'u') or (mSearchIn='r') Then Begin
     ...
     {*****************************************}
     {                Search W_OI                 }
     If (mSearchIn = 'o') Or (mSearchIn = 'a') Or (mSearchIn = 'i')
     Or (mSearchIn = 'e') Or (mSearchIn = 'u')or (mSearchIn='r') Then Begin
     ...
     {*****************************************}
     {                Search W_O                 }
     If (mSearchIn = 'w') Or (mSearchIn = 'o') Or (mSearchIn = 'a')
     Or (mSearchIn = 'i') Or (mSearchIn = 'e') Or (mSearchIn = 'u')or (mSearchIn='r') Then Begin
     ...
     If (mSearchIn = 'z') Or (mSearchIn = 'r') Or (mSearchIn = 'm')
          Or (mSearchIn = 'h')or (mSearchIn='r') Then Begin
     ...
     If (mSearchIn = 'x') Or (mSearchIn = 'q') Or (mSearchIn = 'k')
          Or (mSearchIn = 'c') or (mSearchIn='r')Then Begin
     ...
     If (mSearchIn = 'u') Or (mSearchIn = 'o') Or (mSearchIn = 'i')
          Or (mSearchIn = 'e') Or (mSearchIn = 'a') or (mSearchIn='y')or (mSearchIn='r') Then Begin
