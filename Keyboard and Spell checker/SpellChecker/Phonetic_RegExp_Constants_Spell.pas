...
var
  r_A, r_B, r_C, r_D, r_E, r_F, r_G, r_H, r_I, r_J, r_K, r_L, r_M, r_N, r_O, r_OFirst, r_P, r_Q, r_R, r_RFirst, r_S, r_T, r_U, r_V, r_W, r_X, r_Y, r_Z: string;
  ...
  r_InjectFola, r_InjectHasanta, r_InjectChandraBisharga, r_InjectReph, r_InjectedVowel: string;
...
begin
  ...
  { Single characters }
  r_A := r_InjectReph + '(([' + b_A + b_E + ']' + b_Hasanta + b_Z + b_AAkar + '?)|([' + b_AA + b_E + b_A + '])|([' + ZWJ + ZWNJ + ']?(' + b_Hasanta + b_Z + ')?'
    + b_AAkar + '?)|(' + b_Y + b_AAkar + '))';
  r_B := r_InjectReph + '(' + b_B + ')';
  r_C := r_InjectReph + '([' + b_C + b_CH + '])';
  r_D := r_InjectReph + '([' + b_D + b_Dd + b_Dh + b_Ddh + '])';
  r_E := r_InjectReph + '((' + b_E + b_Hasanta + b_Z + b_AAkar + '?)|([' + b_E + b_Ekar + '])|([' + ZWJ + ZWNJ + ']?(' + b_Hasanta + b_Z + ')' + b_AAkar +
    '?)|(' + b_Y + b_Ekar + '))';
  ...
  // E
  r_EY := r_InjectReph + '((' + b_E + ')|(' + b_I + ')|(' + b_Ekar + ')|(' + b_Ekar + b_I + ')|(' + b_E + b_I + ')|(' + b_II + ')|(' + b_IIkar + ')|(' + r_E +
    r_Y + '))';
  ...
  // A
  // B
  r_BBH := r_InjectReph + '(((' + r_B + ')?(' + b_Hasanta + '?)' + r_BH + ')|(' + r_BB + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_B + '(' + b_Hasanta + '?)' +
    r_B + '(' + b_Hasanta + '?)' + r_H + '))';
  r_BDH := r_InjectReph + '((' + r_B + '(' + b_Hasanta + '?)' + r_DH + ')|(' + r_BD + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_B + '(' + b_Hasanta + '?)' + r_D
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_BHL := r_InjectReph + '((' + r_BH + '(' + b_Hasanta + '?)' + r_L + ')|(' + r_B + '(' + b_Hasanta + '?)' + r_HL + ')|(' + r_B + '(' + b_Hasanta + '?)' + r_H
    + '(' + b_Hasanta + '?)' + r_L + '))';
  // C
  r_CCH := r_InjectReph + '((' + r_C + '(' + b_Hasanta + '?)' + r_CH + ')|(' + r_C + '(' + b_Hasanta + '?)' + r_C + '(' + b_Hasanta + '?)' + r_H + '))';
  r_CHH := r_InjectReph + '((' + r_CH + '(' + b_Hasanta + '?)' + '(' + r_H + ')?' + ')|(' + r_C + '(' + b_Hasanta + '?)' + r_HH + ')|(' + r_C + '(' + b_Hasanta
    + '?)' + r_H + '(' + b_Hasanta + '?)' + r_H + '))';
  r_CNG := r_InjectReph + '((' + b_C + b_Hasanta + b_NYA + ')|(' + r_C + '(' + b_Hasanta + '?)' + r_NG + ')|(' + r_C + '(' + b_Hasanta + '?)' + r_N + '(' +
    b_Hasanta + '?)' + r_G + ')|(' + r_CN + '(' + b_Hasanta + '?)' + r_G + '))';
  // D
  r_DHM := r_InjectReph + '((' + r_DH + '(' + b_Hasanta + '?)' + r_M + ')|(' + r_D + '(' + b_Hasanta + '?)' + r_HM + ')|(' + r_D + '(' + b_Hasanta + '?)' + r_H
    + '(' + b_Hasanta + '?)' + r_M + '))';
  r_DHN := r_InjectReph + '((' + r_DH + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_D + '(' + b_Hasanta + '?)' + r_HN + ')|(' + r_D + '(' + b_Hasanta + '?)' + r_H
    + '(' + b_Hasanta + '?)' + r_N + '))';
  r_DBH := r_InjectReph + '((' + r_D + '(' + b_Hasanta + '?)' + r_BH + ')|(' + r_DB + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_D + '(' + b_Hasanta + '?)' + r_B
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_DDH := r_InjectReph + '(((' + r_D + ')?(' + b_Hasanta + '?)' + r_DH + ')|(' + r_DD + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_D + '(' + b_Hasanta + '?)' +
    r_D + '(' + b_Hasanta + '?)' + r_H + '))';
  r_DGH := r_InjectReph + '((' + r_D + '(' + b_Hasanta + '?)' + r_GH + ')|(' + r_DG + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_D + '(' + b_Hasanta + '?)' + r_G
    + '(' + b_Hasanta + '?)' + r_H + '))';
  // E
  // F
  // G
  r_GDH := r_InjectReph + '((' + r_G + '(' + b_Hasanta + '?)' + r_DH + ')|(' + r_G + '(' + b_Hasanta + '?)' + r_D + '(' + b_Hasanta + '?)' + r_H + '))';
  r_GGH := r_InjectReph + '((' + r_GG + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_G + '(' + b_Hasanta + '?)' + r_GH + ')|(' + r_G + '(' + b_Hasanta + '?)' + r_G
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_GHN := r_InjectReph + '((' + r_GH + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_G + '(' + b_Hasanta + '?)' + r_HN + ')|(' + r_G + '(' + b_Hasanta + '?)' + r_H
    + '(' + b_Hasanta + '?)' + r_N + '))';
  // H
  // I
  // J
  r_JNG := r_InjectReph + '((' + b_J + b_Hasanta + b_NYA + ')|(' + r_J + '(' + b_Hasanta + '?)' + r_NG + ')|(' + r_J + '(' + b_Hasanta + '?)' + r_N + '(' +
    b_Hasanta + '?)' + r_G + '))';
  r_JJH := r_InjectReph + '(((' + r_J + ')?(' + b_Hasanta + '?)' + r_JH + ')|(' + b_H + b_Hasanta + b_Z + ')|(' + r_JJ + '(' + b_Hasanta + '?)' + r_H + ')|(' +
    r_J + '(' + b_Hasanta + '?)' + r_J + '(' + b_Hasanta + '?)' + r_H + '))';
  // K
  r_KSH := r_InjectReph + '((' + r_K + '(' + b_Hasanta + '?)' + r_SH + ')|(' + r_KS + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_S
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_KKH := r_InjectReph + '((' + b_K + b_Hasanta + b_Ss + ')|(' + r_KK + '(' + b_Hasanta + '?)' + r_H + ')|((' + r_K + ')?(' + b_Hasanta + '?)' + r_KH + ')|(' +
    r_K + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_H + '))';
  r_KXM := r_InjectReph + '((' + r_KX + '(' + b_Hasanta + '?)' + r_M + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_XM + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_X
    + '(' + b_Hasanta + '?)' + r_M + '))';
  r_KXN := r_InjectReph + '((' + r_KX + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_XN + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_X
    + '(' + b_Hasanta + '?)' + r_N + '))';
  // L
  r_LKH := r_InjectReph + '((' + r_L + '(' + b_Hasanta + '?)' + r_KH + ')|(' + r_LK + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_L + '(' + b_Hasanta + '?)' + r_K
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_LGH := r_InjectReph + '((' + r_L + '(' + b_Hasanta + '?)' + r_GH + ')|(' + r_LG + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_L + '(' + b_Hasanta + '?)' + r_G
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_LPH := r_InjectReph + '((' + r_L + '(' + b_Hasanta + '?)' + r_PH + ')|(' + r_LP + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_L + '(' + b_Hasanta + '?)' + r_P
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_LDH := r_InjectReph + '((' + r_L + '(' + b_Hasanta + '?)' + r_DH + ')|(' + r_LD + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_L + '(' + b_Hasanta + '?)' + r_D
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_LBH := r_InjectReph + '((' + r_L + '(' + b_Hasanta + '?)' + r_BH + ')|(' + r_LB + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_L + '(' + b_Hasanta + '?)' + r_B
    + '(' + b_Hasanta + '?)' + r_H + '))';
  // M
  r_MBH := r_InjectReph + '((' + r_M + '(' + b_Hasanta + '?)' + r_BH + ')|(' + r_MB + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_M + '(' + b_Hasanta + '?)' + r_B
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_MPH := r_InjectReph + '((' + r_M + '(' + b_Hasanta + '?)' + r_PH + ')|(' + r_MP + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_M + '(' + b_Hasanta + '?)' + r_P
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_MTH := r_InjectReph + '((' + r_M + '(' + b_Hasanta + '?)' + r_TH + ')|(' + r_MT + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_M + '(' + b_Hasanta + '?)' + r_T
    + '(' + b_Hasanta + '?)' + r_H + '))';
  // N
  r_NSH := r_InjectReph + '((' + r_N + '(' + b_Hasanta + '?)' + r_SH + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_S + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NDH := r_InjectReph + '((' + r_N + '(' + b_Hasanta + '?)' + r_DH + ')|(' + r_ND + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_D
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NKH := r_InjectReph + '((' + r_N + '(' + b_Hasanta + '?)' + r_KH + ')|(' + r_NK + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_K
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NTH := r_InjectReph + '((' + r_N + '(' + b_Hasanta + '?)' + r_TH + ')|(' + r_NT + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_T
    + '(' + b_Hasanta + '?)' + r_H + '))';
  ...
  r_NGG := r_InjectReph + '((' + b_NGA + b_Hasanta + b_G + ')|(' + r_NG + '(' + b_Hasanta + '?)' + r_G + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_G + '(' +
    b_Hasanta + '?)' + r_G + '))';
  ...
  r_NGH := r_InjectReph + '((' + b_NGA + b_Hasanta + b_GH + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_GH + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_G + '(' +
    b_Hasanta + '?)' + r_H + '))';
  r_NCH := r_InjectReph + '((' + r_N + '(' + b_Hasanta + '?)' + r_CH + ')|(' + r_NC + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_C
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NJH := r_InjectReph + '((' + r_N + '(' + b_Hasanta + '?)' + r_JH + ')|(' + r_NJ + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_J
    + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NGC := r_InjectReph + '((' + r_NG + '(' + b_Hasanta + '?)' + r_C + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_G + '(' + b_Hasanta + '?)' + r_C + '))';
  // O
  // P
  r_PHL := r_InjectReph + '((' + r_PH + '(' + b_Hasanta + '?)' + r_L + ')|(' + r_P + '(' + b_Hasanta + '?)' + r_HL + ')|(' + r_P + '(' + b_Hasanta + '?)' + r_H
    + '(' + b_Hasanta + '?)' + r_L + '))';
  // Q
  // R
  ...
  r_SHM := r_InjectReph + '((' + r_SH + '(' + b_Hasanta + '?)' + r_M + ')|(' + r_S + '(' + b_Hasanta + '?)' + r_HM + ')|(' + r_S + '(' + b_Hasanta + '?)' + r_H
    + '(' + b_Hasanta + '?)' + r_M + '))';
  r_SHN := r_InjectReph + '((' + r_SH + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_S + '(' + b_Hasanta + '?)' + r_HN + ')|(' + r_S + '(' + b_Hasanta + '?)' + r_H
    + '(' + b_Hasanta + '?)' + r_N + '))';
  // T
  r_T_Acnt_Acnt := r_InjectReph + '(' + b_Khandatta + ')';
  r_TTH := r_InjectReph + '(((' + r_T + ')?(' + b_Hasanta + '?)' + r_TH + ')|(' + r_TT + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_T + '(' + b_Hasanta + '?)' +
    r_T + '(' + b_Hasanta + '?)' + r_H + '))';
  // U
  // V
  // W
  ...
  // Y
  // Z
  r_ZZH := r_InjectReph + '((' + b_H + b_Hasanta + b_Z + ')|(' + r_Z + '(' + b_Hasanta + '?)' + r_ZH + ')|(' + r_ZZ + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_Z
  ...
  // J
  // K
  r_KSHM := r_InjectReph + '((' + r_KSH + '(' + b_Hasanta + '?)' + r_M + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_SHM + ')|(' + r_KS + '(' + b_Hasanta + '?)' +
    r_HM + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_SH + '(' + b_Hasanta + '?)' + r_M + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_S + '(' + b_Hasanta + '?)' +
    r_H + '(' + b_Hasanta + '?)' + r_M + '))';
  r_KKHM := r_InjectReph + '((' + r_KKH + '(' + b_Hasanta + '?)' + r_M + ')|(' + r_KK + '(' + b_Hasanta + '?)' + r_HM + ')|(' + r_K + '(' + b_Hasanta + '?)' +
    r_K + '(' + b_Hasanta + '?)' + r_H + '(' + b_Hasanta + '?)' + r_M + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_KH + '(' + b_Hasanta + '?)' + r_M + '))';
  r_KSHN := r_InjectReph + '((' + r_KSH + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_SHN + ')|(' + r_KS + '(' + b_Hasanta + '?)' +
    r_HN + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_SH + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_S + '(' + b_Hasanta + '?)' +
    r_H + '(' + b_Hasanta + '?)' + r_N + '))';
  r_KKHN := r_InjectReph + '((' + r_KKH + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_KK + '(' + b_Hasanta + '?)' + r_HN + ')|(' + r_K + '(' + b_Hasanta + '?)' +
    r_K + '(' + b_Hasanta + '?)' + r_H + '(' + b_Hasanta + '?)' + r_N + ')|(' + r_K + '(' + b_Hasanta + '?)' + r_KH + '(' + b_Hasanta + '?)' + r_N + '))';
  // L
  // M
  // N
  r_NGCH := r_InjectReph + '((' + r_NG + '(' + b_Hasanta + '?)' + r_CH + ')|(' + r_NGC + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' +
    r_G + '(' + b_Hasanta + '?)' + r_C + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NGGH := r_InjectReph + '((' + r_NG + '(' + b_Hasanta + '?)' + r_GH + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_GG + '(' + b_Hasanta + '?)' + r_H + ')|(' +
    r_N + '(' + b_Hasanta + '?)' + r_GGH + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_G + '(' + b_Hasanta + '?)' + r_G + '(' + b_Hasanta + '?)' + r_H + ')|(' +
    r_NG + '(' + b_Hasanta + '?)' + r_G + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_NGG + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NGKH := r_InjectReph + '((' + r_NG + '(' + b_Hasanta + '?)' + r_KH + ')|(' + r_NG + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_H + ')|(' +
    r_N + '(' + b_Hasanta + '?)' + r_G + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_NGK + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NGKX := r_InjectReph + '((' + r_NG + '(' + b_Hasanta + '?)' + r_KX + ')|(' + r_NGK + '(' + b_Hasanta + '?)' + r_X + ')|(' + r_N + '(' + b_Hasanta + '?)' +
    r_G + '(' + b_Hasanta + '?)' + r_KX + ')|(' + r_N + '(' + b_Hasanta + '?)' + r_G + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_X + '))';
  r_NGJH := r_InjectReph + '((' + r_NG + '(' + b_Hasanta + '?)' + r_JH + ')|(' + r_NGJ + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' +
  ...
  // R
  // S
  r_SHSH := r_InjectReph + '(((' + r_SH + ')?(' + b_Hasanta + '?)' + r_SH + ')|(' + r_S + '(' + b_Hasanta + '?)' + r_H + '(' + b_Hasanta + '?)' + r_S + '(' +
    b_Hasanta + '?)' + r_H + '))';
  // T
  r_THTH := r_InjectReph + '((' + b_T + b_Hasanta + b_Th + ')|((' + r_TH + ')?(' + b_Hasanta + '?)' + r_TH + ')|(' + r_T + '(' + b_Hasanta + '?)' + r_H + '(' +
  ...
  // C
  r_CHCHH := r_InjectReph + '((' + b_C + b_Hasanta + b_CH + ')|(' + r_CH + '(' + b_Hasanta + '?)' + r_CHH + ')|(' + r_CH + '(' + b_Hasanta + '?)' + r_CH + '(' +
    b_Hasanta + '?)' + r_H + ')|(' + r_C + '(' + b_Hasanta + '?)' + r_H + '(' + b_Hasanta + '?)' + r_C + '(' + b_Hasanta + '?)' + r_H + '(' + b_Hasanta + '?)' +
    r_H + '))';
  r_NGKSH := r_InjectReph + '((' + r_NGK + '(' + b_Hasanta + '?)' + r_SH + ')|(' + r_NG + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_SH + ')|(' +
    r_NG + '(' + b_Hasanta + '?)' + r_KSH + ')|(' + r_NG + '(' + b_Hasanta + '?)' + r_KS + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' +
    r_G + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_S + '(' + b_Hasanta + '?)' + r_H + '))';
  r_NGKKH := r_InjectReph + '((' + r_NG + '(' + b_Hasanta + '?)' + r_KKH + ')|(' + r_NGK + '(' + b_Hasanta + '?)' + r_KH + ')|(' + r_NG + '(' + b_Hasanta + '?)'
    + r_K + '(' + b_Hasanta + '?)' + r_KH + ')|(' + r_NG + '(' + b_Hasanta + '?)' + r_KK + '(' + b_Hasanta + '?)' + r_H + ')|(' + r_N + '(' + b_Hasanta + '?)' +
    r_G + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_K + '(' + b_Hasanta + '?)' + r_H + '))';
end;
