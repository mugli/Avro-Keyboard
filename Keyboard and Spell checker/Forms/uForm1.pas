...
Type
        TAvroMainForm1 = Class(TForm)
                ...
                Procedure OTFBanglaFontscamewithAvroKeyboard1Click
                  (Sender: TObject);
                ...
                Procedure EnableOldStyleRephInModernTypingStyle1Click
                  (Sender: TObject);
                ...
                Procedure AutomaticallyfixChandrapositionInModernTypingStyle1Click
                  (Sender: TObject);
                Procedure AutomaticVowelFormatingInModernTypingStyle1Click
                  (Sender: TObject);
                ...
                Procedure KeyboardLayoutEditorBuildcustomlayouts1Click
                  (Sender: TObject);
                ...
                Procedure Remembermychoiceamongsuggestions1Click
                  (Sender: TObject);
                Procedure UseVerticalLinePipekeytotypeDot1Click
                  (Sender: TObject);
        ...
        Private
                ...
                Procedure KeyLayout_KeyboardLayoutChanged
        ...
        Public
                ...
                Procedure TransferKeyUp(Const KeyCode: Integer;
                  Var Block: Boolean);
...
Begin
        ...
        Else
                KeyboardLayoutPath := GetAvroDataDir + 'Keyboard Layouts\' +
                  KeyboardLayout + '.avrolayout';
...
Begin
        ...
        Else
                SkinPath := GetAvroDataDir + 'Skin\' + InterfaceSkin +
                  '.avroskin';
        ...
        Begin
                ...
                Begin
                        If Selectkeyboardlayout1.Items[J].Tag = 9903 Then
                                If Lowercase
                                  ((Selectkeyboardlayout1.Items[J]
                                  As TMenuItemExtended).Value)
                                  = Lowercase(sCaption) Then
                                        ItemFound := True;
                End;
                ...
                Begin
                        ...
                        Selectkeyboardlayout2.Insert
                          (AvroPhoneticEnglishtoBangla3.MenuIndex + 1,
                          TempMenu1);
                End;
                ...
                Begin
                        ...
                        Selectkeyboardlayout1.Insert
                          (AvroPhoneticEnglishtoBangla2.MenuIndex + 1,
                          TempMenu2);
                End;
                ...
                Begin
                        If Popup_LayoutList.Items.Items[J].Tag = 9903 Then
                                If Lowercase
                                  ((Popup_LayoutList.Items.Items[J]
                                  As TMenuItemExtended).Value)
                                  = Lowercase(sCaption) Then
                                        ItemFound := True;
                End;
                ...
                Begin
                        ...
                        Popup_LayoutList.Items.Insert
                          (AvroPhoneticEnglishtoBangla1.MenuIndex + 1,
                          TempMenu3);
                End;
        End;
End;
...
Begin
        ...
        Begin
                ...
                Begin
                        If WindowDict.TryGetValue(ParentHwnd,
                          ParenWindowRecord) Then
                        Begin
        ...
        Begin
                ...
                Begin
                        ...
                        MyCurrentKeyboardMode := SysDefault;
                        If ChangeInputLocale = 'YES' Then
                                ChangeLocalToAny(hforewnd,
                                  NewWindowRecord.Locale);
        ...
        Begin
                ...
                Begin
                        ...
                        Tray.Hint := 'Avro Keyboard.' + #13 +
                          'Running Bangla Keyboard Mode.' + #13 + 'Press ' +
                          ModeSwitchKey + ' to switch to System default.';
                End
                Else If CurrentMode = SysDefault Then
                Begin
                        If IsWin2000 = True Then
                        ...
                        Tray.Hint := 'Avro Keyboard.' + #13 +
                          'Running System default Keyboard Mode.' + #13 +
...
Begin
        Case HelpID Of
                23:
                        ...
                        Else
                                Execute_Something
                                  ('http://www.omicronlab.com/go.php?id=' +
                                  IntToStr(HelpID));
...
Begin
        ...
        Begin
                ...
                AutomaticallyfixChandrapositionInModernTypingStyle1.
                  Enabled := False;
                AutomaticallyfixChandrapositionInModernTypingStyle2.
                  Enabled := False;
        ...
        Begin
                ...
                Begin
                        ...
                        AutomaticVowelFormatingInModernTypingStyle1.
                          Enabled := True;
                        AutomaticVowelFormatingInModernTypingStyle2.
                          Enabled := True;
                        AutomaticallyfixChandrapositionInModernTypingStyle1.
                          Enabled := True;
                        AutomaticallyfixChandrapositionInModernTypingStyle2.
...
Begin
        ...
        Begin
                ...
                Tray.Hint := 'Avro Keyboard.' + #13 +
                  'Running System default Keyboard Mode.' + #13 + 'Press ' +
                  ModeSwitchKey + ' to switch to Bangla.';
        End;
...
Begin
        ...
        Begin
                ...
                If (WindoRecord.Mode = 'B') And
                  (KeyLayout.KeyboardMode = SysDefault) Then
                        KeyLayout.KeyboardMode := bangla;
                If (WindoRecord.Mode = 'S') And
                  (KeyLayout.KeyboardMode = bangla) Then
                        KeyLayout.KeyboardMode := SysDefault;
        End;
